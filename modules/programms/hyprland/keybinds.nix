  ...
  flake.homeModules.hyprland-wm = {
    wayland.windowManager.hyprland.settings = {
      ...
      bind = [
        ...
        "$mainMod CTRL, Return, exec, $alt-terminal"
        "$mainMod, W, killactive,"
        "$mainMod SHIFT, W, exec, $power"
        "$mainMod, M, exit,"
        ...
        # Wallpaper Switch
        "$mainMod, Left, exec, wpaperctl previous"
        "$mainMod, Right, exec, wpaperctl next"
